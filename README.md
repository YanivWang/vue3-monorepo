...
| **测试与全量门禁**        | 根仓库 **Vitest** 单测（支持 coverage）；`pnpm run verify:full` 串联引用检查、`check:request-core`（**`@vue3-monorepo/request-core`**）、`check:theme`（主题产物同步）、类型、Lint、样式、Prettier、测试与 **admin / h5 / docs** 构建                                                                                                                                                                                                                                                                                                   |
