...
| **测试与全量门禁**        | 根仓库 **Vitest** 单测（支持 coverage）；`pnpm run verify:full` 串联引用检查、`check:request-core`（**`@vue3-monorepo/request-core`**）、类型、Lint、样式、Prettier、测试与 **admin / h5 / docs** 构建                                                                                                                                                                                                                                                                                                                                                                        |
...
| 全量门禁（引用检查、`check:request-core`、`@vue3-monorepo/request-core` / `@vue3-monorepo/web-monitor` / `@vue3-monorepo/js-bridge` 等大改时的门禁说明见 [quality-gates](docs/guide/quality-gates.md)） | `pnpm run verify:full`                                                  |
