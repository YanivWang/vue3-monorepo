...
import { registerDirectives as registerPcDirectives } from '@vue3-monorepo/shared/directives-pc'
import { useUserStore } from '@/stores/modules/user'

/**
 * Admin 应用级指令注册：将 @vue3-monorepo/shared/directives-pc 注入用户权限/角色判断。
 */
