import { createHttp, type CreateHttpOptions, type HttpRequest } from '@vue3-mono/request'
import { createTokenStorage, type TokenStorage } from '@vue3-mono/utils'
...
export type { TokenStorage } from '@vue3-mono/utils'
export type {
  RequestConfig,
  ResponseData,
  CreateHttpOptions,
