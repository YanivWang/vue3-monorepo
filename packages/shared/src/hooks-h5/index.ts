 ...
 *
 * H5 端专用 hooks（依赖 Vant / @vue3-monorepo/js-bridge / vue-router）
 *
...
export { useSmsCodeGate } from '@vue3-monorepo/shared/hooks-core'
export type { UseSmsCodeGateReturn } from '@vue3-monorepo/shared/hooks-core'
