/**
 * @vue3-mono/shared/hooks-h5
 *
 * H5 端专用 hooks（依赖 Vant / @vue3-mono/shared/bridge / vue-router）
 *
 ...
 * - useSmsCodeGate：短信验证码发送节流（自 @vue3-mono/shared/hooks-core 再导出，便于 H5 侧单一入口）
 */

export { useSmsCodeGate } from '@vue3-mono/shared/hooks-core'
export type { UseSmsCodeGateReturn } from '@vue3-mono/shared/hooks-core'
