...
$skeleton-color: var(--el-fill-color-light, var(--color-fill-light, var(--color-bg-page)));
$skeleton-shine: var(--el-fill-color-lighter, var(--color-fill-lighter, var(--color-border-subtle)));
